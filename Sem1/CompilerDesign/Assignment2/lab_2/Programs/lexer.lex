...
boolean 			(true|false)
integerDec 			[0-9]+(u|U)?
integerOct 			0[1-7][0-7]+(u|U)?
integerHex 			0(x|X)?[a-fA-F0-9]+(u|U)?
typestr 			color|void|bool|int|uint|float|double|(vec|dvec|bvec|ivec|mat|dmat)[234]|(mat|dmat)[234](x)[234]
identifier 			[A-Za-z_]+[0-9A-Za-z_]*
statevar  			(rt_[0-9a-zA-Z]+)
floating 			[+-]?(([0-9]*[.]([0-9]*[e|E][-|+|0-9])[0-9]*)|(([0-9]*[e|E][-|+|0-9])[0-9]*)|([0-9]*[.]{1}[0-9]*))+(f|F|lf|LF)?
whitespace 			[ \t\r\v\a\e\f]
comments 			(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(\/\/.*)
