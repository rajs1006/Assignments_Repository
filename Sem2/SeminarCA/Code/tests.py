...
class Tests(unittest.TestCase):
    ...
    def test_identify_faces(self):
        face_space_threshold=1.0
        cutoff_threshold=1.0
        self.setup_tests("identify_faces", cutoff_threshold)
        plot_identified_faces(self.scores, self.imgs_train, self.imgs_test, self.pcs, self.coeffs_test, self.mean_data,face_space_threshold,cutoff_threshold)
