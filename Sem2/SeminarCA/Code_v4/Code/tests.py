...
class Tests(unittest.TestCase):
    ...
    def test_identify_faces(self):
        space_threshold = 1.0
        class_threshold = 0.8
        self.setup_tests("identify_faces", class_threshold)
        plot_identified_faces(self.scores, self.imgs_train, self.imgs_test, self.pcs, self.coeffs_test, self.mean_data, space_threshold , class_threshold)
